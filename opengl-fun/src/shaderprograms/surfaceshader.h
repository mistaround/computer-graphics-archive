...
public:
    ...
    int unifCam; // A handle for the "uniform" vec3 representing the camera position in the vertex shader
public:
    ...
    // Pass the given Camera postion to this shader on the GPU
    void setCamVector(const glm::vec3 &pos);
};
